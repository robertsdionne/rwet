...
cat data/L16+h-eva/f1r.P* | ./process_voynich.py | ./chunk_words.py -d cmudict07a.json \
...
cat data/L16+h-eva/f39v.P* | ./process_voynich.py | ./chunk_words.py -d cmudict07a.json \
...
cat data/L16+h-eva/f81r.P* | ./process_voynich.py | ./chunk_words.py -d cmudict07a.json \
