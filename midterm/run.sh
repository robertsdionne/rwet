...
echo "processing f1r"
cat data/L16+h-eva/f1r.P* | ./process_voynich.py | ./translate.py --image f1r.png \
...
cat data/L16+h-eva/f39v.P* | ./process_voynich.py | ./translate.py --image f39v.png \
...
cat data/L16+h-eva/f81r.P* | ./process_voynich.py | ./translate.py --image f81r.png \
